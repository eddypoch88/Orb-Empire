  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6">
      <div className="login-container glass-card p-16 text-center max-w-[480px] w-full animate-in fade-in slide-in-from-bottom-8 duration-700">
        ...
        <p className="text-slate-500 mb-12 font-normal text-lg">Identity verification protocol active.</p>
          ...
          <SignIn
            ...
            appearance={{
              elements: {
                ...
                formFieldAction: 'text-indigo-400 hover:text-indigo-300 font-semibold text-sm',
              }
            }}
          />
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/5">
          <p className="text-slate-600 text-xs font-medium tracking-widest uppercase">
            Orb Empire • Operational Control
          </p>
        </div>
      </div>
    </main>
